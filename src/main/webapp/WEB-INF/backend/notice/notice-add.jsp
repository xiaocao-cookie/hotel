...
<div class="layui-fluid">
    <div class="layui-row">
        <form class="layui-form">
            <input hidden value="${sessionScope.loginUser.id}" name="sendUid" id="sendUid">
            <div class="layui-form-item">
                <label for="sendName" class="layui-form-label">
                    <span class="x-red">*</span>发送者</label>
                <div class="layui-input-inline">
                    <input type="text" id="sendName" name="sendName" value="${sessionScope.loginUser.loginName}" disabled class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                            ...
                            <tbody>
                                <tr>
                                    <c:forEach items="${userList}" var="user" begin="0" step="1" end="${userList.size()/6}">
                                        <td><input type="checkbox" value="${user.id}" name="userName" lay-skin="primary" title="${user.loginName}"></td>
                                    </c:forEach>
                                </tr>
                                <tr>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <textarea placeholder="请输入内容" class="layui-textarea" name="content" id="content" style="width: 500px"></textarea>
                </div>
            </div>
            <div class="layui-form-item" style="margin-left: 110px">
                <button type="button" style="width: 86px" class="layui-btn" onclick="addNotice();">发布</button>
