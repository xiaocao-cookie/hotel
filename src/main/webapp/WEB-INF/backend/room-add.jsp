        ...
        <form class="layui-form">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="roomName" name="roomName" required autocomplete="off" class="layui-input">
                    <i style="position: absolute;top: 8px;left: 165px;font-size: 20px;color: #5FB878;" id="roomNameOk" hidden class="layui-icon layui-icon-ok-circle"></i>
                    <i style="position: absolute;top: 8px;left: 165px;font-size: 20px;color: red" id="roomNameClose" hidden class="layui-icon layui-icon-close-fill"></i>
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item" style="margin-left: 110px">
                <button type="button" style="width: 86px" class="layui-btn" onclick="addRoom();">添加</button>
...
<script>
    ...
    $("input[name='roomName']").blur(function () {
        ...
        $.ajax({
            url: contextPath + "/Room/verifyRoomName",
            method: 'post',
            data:{
                roomName: roomName
            },
