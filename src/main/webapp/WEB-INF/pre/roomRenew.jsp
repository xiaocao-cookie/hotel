...
<div class="layui-col-md10 layui-col-md-offset1">
    ...
    <table class="layui-table" lay-size="lg">
            ...
            <td>
                <div class="layui-inline">
                    <div class="layui-input-inline">
                        <input disabled type="text" class="layui-input" id="beginTime"
                               value="<fmt:formatDate value="${roomOrder.endTime}" pattern="yyyy-MM-dd" />" >
                    </div>
                    --
                    <div class="layui-input-inline">
        ...
        <tr>
            <td>价格(单位：元)</td>
            <td id="cost" hidden>${roomOrder.cost}</td>
    ...
    <input type="text" class="layui-input" id="startTime"
           value="<fmt:formatDate value="${roomOrder.startTime}" pattern="yyyy-MM-dd" />" style="display: none">
    <br/>
    <button type="button" class="layui-btn layui-btn-lg layui-btn-danger" style="margin-left: 350px" id="orderRoom"
            onclick="renewRoom(${roomOrder.id});">续租并支付</button>
